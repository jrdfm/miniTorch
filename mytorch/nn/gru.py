...
class GRUUnit(Module):
    ...
    def forward(self, input, hidden = None):
        ...
        '''
        effective_batch_size, _  = input.shape 
        if hidden is None:
        ...
        h_n =   Tanh()(input @ self.weight_in.T() + self.bias_in + rt * (hidden @ (self.weight_hn.T()) + self.bias_hn))
        h_t = (Tensor(1) - zt) * h_n + zt * hidden # don't know why this works
        return h_t
